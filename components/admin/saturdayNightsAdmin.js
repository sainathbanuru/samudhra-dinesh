...
export default class SaturdayNightsAdmin extends React.Component {
  state = {
  ...
  componentDidMount() {
    firestore
      ...
      .get()
      .then(saturdayNights => {
        const saturdayNightsData = saturdayNights.data();
        const saturdayNightsContent = saturdayNightsData.content;
        const blocksFromHtml = htmlToDraft(saturdayNightsContent);
