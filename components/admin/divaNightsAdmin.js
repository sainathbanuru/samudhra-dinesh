...
export default class DivaNightsAdmin extends React.Component {
  state = {
  ...
  componentDidMount() {
    firestore
      ...
      .then(divaNights => {
        // divaNights.data();
        const divaNightData = divaNights.data();
        const divaNightContent = divaNightData.content;
        const blocksFromHtml = htmlToDraft(divaNightContent);
