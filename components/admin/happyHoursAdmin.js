...
export default class HappyHoursAdmin extends React.Component {
  state = {
    days: "",
    timings: "",
    error: "",
  ...
  componentDidMount() {
    firestore
      ...
      .get()
      .then(happyHours => {
        const happyHoursData = happyHours.data();
        const happyHoursContent = happyHoursData.content;
        const blocksFromHtml = htmlToDraft(happyHoursContent);
