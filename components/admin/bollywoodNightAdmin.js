...
export default class BollywoodNightAdmin extends React.Component {
  state = {
  ...
  componentDidMount() {
    firestore
      ...
      .get()
      .then(bollywoodNight => {
        const bollywoodNightData = bollywoodNight.data();
        const bollywoodNightContent = bollywoodNightData.content;
        const blocksFromHtml = htmlToDraft(bollywoodNightContent);
